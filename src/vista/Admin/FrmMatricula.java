...
public class FrmMatricula extends javax.swing.JFrame {
  ...
  public void cargarTabla(){
        ...
        public void guardar(){
                if (validar()) {
                        if (Utiles.validarFechaNoPasada(jdtRegistro.getDate())) {
                                JOptionPane.showMessageDialog(null, "Datos correctos", "Datos corrctos guardados", JOptionPane.INFORMATION_MESSAGE);
                        } else {
                                JOptionPane.showMessageDialog(null, "Ingresar fecha actual", "Fecha Incorrecta", JOptionPane.ERROR_MESSAGE);
                        }
                } else {
        ...
        public Boolean validar(){
                if (!txtCiclo.getText().trim().isEmpty() &&
                        !txtNumMatricula.getText().trim().isEmpty() && 
                        (jdtRegistro.getDate() != null)){
                        return true;
                } else {
                        return false;
                }
    ...
    @SuppressWarnings("unchecked")
        ...
        private void initComponents() {
                ...
                jdtRegistro = new com.toedter.calendar.JDateChooser();
                ...
                jPanel1.add(txtCiclo, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 60, 130, -1));
                ...
                jPanel1.add(txtNumMatricula, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 140, 130, -1));
                jPanel1.add(jdtRegistro, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 100, 130, -1));
    ...
    public static void main(String args[]) {
        ...
        private com.toedter.calendar.JDateChooser jdtRegistro;
